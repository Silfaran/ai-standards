...
| Frontend Developer | [`frontend.md`](frontend.md), [`security.md`](security.md), [`performance.md`](performance.md), [`observability.md`](observability.md), [`api-contracts.md`](api-contracts.md), `design-decisions.md` | [`caching.md`](caching.md) when wiring HTTP cache headers or consuming cached endpoints, [`frontend-reference.md`](frontend-reference.md), [`quality-gates.md`](quality-gates.md) |
